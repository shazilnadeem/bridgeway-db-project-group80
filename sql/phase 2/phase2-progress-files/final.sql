------------------------------------------------------------
-- group80_p2_master.sql (Base Schema) | Bridgeway Database - Phase 2
------------------------------------------------------------

------------------------------------------------------------
-- 0. Create / Reset Database | Purpose: recreate BridgewayDB cleanly
------------------------------------------------------------
USE master;
GO
...
------------------------------------------------------------
-- 1. Table Definitions (Schema) | Owner: Base Schema (do not edit)
------------------------------------------------------------
...
------------------------------------------------------------
-- Schema Extension: tbl_Engineer_Archive | Owner: Zaid | Purpose: archive engineer profiles
------------------------------------------------------------
...
------------------------------------------------------------
-- 2. Lookup / Enum Seed Data | Owner: Shazil | Shared static platform values
------------------------------------------------------------
-- Notes:
--   - Base skills reside in tbl_Skill.
--   - Additional lookup/status values are added on request (maintained by Shazil).
...
------------------------------------------------------------
-- 3. Partitioning & Large-Table Design | Owner: Shazil | Performance & archival
------------------------------------------------------------
-- Scope:
--   - Partition large tables (e.g., tbl_Job_Application) with date-based elimination.
--   - Maintain partition functions/schemes and any related CREATE/SWITCH logic.
------------------------------------------------------------
